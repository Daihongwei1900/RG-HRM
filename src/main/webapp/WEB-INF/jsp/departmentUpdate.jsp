            ...
            <div class="modal-body">
                <form class="form-horizontal update_dept_form">
                    <div class="form-group">
                        <label for="update_deptName" class="col-sm-2 control-label">教师名称</label>
                        <div class="col-sm-8">
                            <input type="text" name="deptName" class="form-control" id="update_deptName">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="update_deptLeader" class="col-sm-2 control-label">教师职称</label>
                        <div class="col-sm-8">
...
<script type="text/javascript">
    ...
    $(".dept_edit_btn").click(function () {
        ...
        edit_deptName = $(this).parent().parent().find("td:eq(1)").text();
        alert("确认修改"+edit_deptName+"信息吗？");
        //查询对应deptId的教师信息
        $.ajax({
            ...
            success:function (result) {
                if (result.code == 100){
                    var deptData = result.extendInfo.teacher;
                    //回显
