        ...
        <div class="hrms_main_ad col-sm-10">
            <div class="panel panel-success">
                <div class="panel-heading">
                    <h3 style="text-align: center;">欢迎报考南京邮电大学！</h3>
                </div>
                <div class="panel-body" style="position:relative; top:-15px;">
                    <div id="hrms_carousel_1" class="carousel slide" data-ride="carousel">
                        <ol class="carousel-indicators">
                            ...
                            <li data-target="#hrms_carousel_1" data-slide-to="3"></li>
                        </ol>

                        <div class="carousel-inner" role="listbox">
                            <div class="item active" style="text-align: center;">
                                <img class="img-responsive center-block" src="/static/img/njupt1.jpg" alt="njupt1">
                                <div class="carousel-caption">
                                    <h3>南门</h3>
                                </div>
                            </div>
                            <div class="item">
                                <img class="img-responsive center-block" src="/static/img/njupt2.jpg" alt="njupt2">
                                <div class="carousel-caption">
                                    <h3>教学楼</h3>
                                </div>
                            </div>
                            <div class="item">
                                <img class="img-responsive center-block" src="/static/img/njupt3.jpg" alt="njupt3">
                                <div class="carousel-caption">
                                    <h3>图书馆</h3>
                                </div>
                            </div>
                            <div class="item">
                                <img class="img-responsive center-block" src="/static/img/njupt4.jpg" alt="njupt4">
                                <div class="carousel-caption">
                                    <h3>滕椅</h3>
                                </div>
                            </div>
